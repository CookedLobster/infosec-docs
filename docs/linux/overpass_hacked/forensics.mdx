...
keywords: [Overpass Hacked, TryHackMe, tryhackme, ctf, pentesting, guide, docs, tutorial, enumeration, exploitation, nmap, privilege escalation, pcap, go backdoor]
---
...
- The Attacker Estabilished Persistence Using: <b style={{ color: 'Plum' }}>[Golang SSH Backdoor]</b>
- <a class="button button--outline button--warning" href="https://github.com/NinjaJc01/ssh-backdoor">GO SSH Backdoor Github</a>
