...
description: Agent SUDO TryHackMe
...
- **Page: <b style={{ color: 'SandyBrown' }}>[IP:80/agent_C_attention.php]</b>**
- Through Fuzzing we discover the **Accepted Codename:** `C`
- Examining the Output we can Discover the **Username:** <b style={{ color: 'Chartreuse' }}>chris</b> and the Initials of another **Agent:** `J`
