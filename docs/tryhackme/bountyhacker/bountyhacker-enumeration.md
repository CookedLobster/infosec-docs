...
```log
Nmap scan report for 10.10.21.169
...
- There are Two Files: **`[locks.txt` - `task.txt]`**

```log
Connected to 10.10.21.169.
220 (vsFTPd 3.0.3)
ftp> ls -a
...
- **Note:** `task.txt`
- **Found Username:** <b style={{ color: 'Chartreuse' }}>lin</b>
...
- **Note:** `locks.txt`
- Possible `SSH` **Password Combinations.**
