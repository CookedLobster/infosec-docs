...
<Tabs>
  <TabItem value="attacker" label="Target"> 
    <div style={{color: 'red'}}>
...
```
  ...
  <TabItem value="target" label="Attacker">
    <div style={{color: 'red'}}>

```batch
wget -O "suspicious.pcapng" "http://IP:8888/suspicious.pcapng"
```

```batch
curl -O "http://IP:8888/suspicious.pcapng"
```
