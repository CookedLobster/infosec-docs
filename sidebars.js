      ...
      items: [
        {
          ...
          label: "Alfred",
          items: [
            "tryhackme-win/alfred/alfred-enumeration",
            "tryhackme-win/alfred/alfred-exploitation",
          ],
        },
        {
          type: "category",
          label: "Blaster",
          items: [
            "tryhackme-win/blaster/blaster-enumeration",
            "tryhackme-win/blaster/blaster-exploitation",
          ],
        },
        {
          type: "category",
          label: "Blue",
          items: [
            "tryhackme-win/blue/blue-enumeration",
            "tryhackme-win/blue/blue-exploitation",
          ],
        },
        {
          type: "category",
          label: "HackPark",
          items: [
            "tryhackme-win/hackpark/hackpark-enumeration",
            "tryhackme-win/hackpark/hackpark-blogengine",
            "tryhackme-win/hackpark/hackpark-exploitation",
          ],
        },
        {
          type: "category",
          label: "Ice",
          items: [
            "tryhackme-win/ice/ice-enumeration",
            "tryhackme-win/ice/ice-exploitation",
          ],
        },
        {
          type: "category",
          label: "Relevant",
          items: [
            "tryhackme-win/relevant/relevant-enumeration",
            "tryhackme-win/relevant/relevant-exploitation",
          ],
        },
        {
          type: "category",
          ...
          items: [
            "tryhackme-win/steelmountain/steelmountain-enumeration",
            "tryhackme-win/steelmountain/steelmountain-exploitation",
            "tryhackme-win/steelmountain/steelmountain-manual",
          ],
        },
      ],
    },
